...
const SHARKD_SOCKET = "/home/ced/sharkd.sock"

// Make sure CAPTURES_PATH has a trailing /
let _captures_path = "/home/ced/captures/"
...
const SHARKD_INTEGER_PARAMS = new Set([
  "frame",
  "ref_frame",
  "prev_frame",
  "skip",
...
const SHARKD_BOOLEAN_PARAMS = new Set([
  "proto",
  "columns",
  "color",
  "bytes",
